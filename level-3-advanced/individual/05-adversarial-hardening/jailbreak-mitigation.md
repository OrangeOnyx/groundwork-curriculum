...
Jailbreak resistance is layered: policy-aware prompting, classifier or rule checks, constrained tools, output review, and human escalation for high-impact requests. Measure bypass rate against an evolving suite.
