...
On-call owns response, not every root cause. Provide runbooks, safe toggles, trace access, escalation contacts, and a rotation that covers product, platform, security, and domain expertise.
