...
Safety is designed into inputs, outputs, tools, data, operations, and governance. A disclaimer is not a safeguard when an assistant can notify a vendor, expose a ledger, or influence a housing decision.
