...
Reindex behind a versioned collection, validate recall and access controls, dual-read or shadow-test, then atomically cut over. Never mutate the only live index during a large embedding or chunking migration.
