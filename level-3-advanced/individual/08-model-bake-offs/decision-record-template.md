...
Record the problem, alternatives, evidence, costs, risks, decision owner, expiry date, and rollback plan. A decision record preserves why a model was selected when providers and benchmarks change.
