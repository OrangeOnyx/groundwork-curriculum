...
Never give an agent broad database access because it is convenient. Enforce tenant-scoped retrieval, allowlisted fields, short-lived credentials, redaction, egress controls, and auditable access decisions.
