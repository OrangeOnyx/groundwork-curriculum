...
Playbooks should start with containment: disable the action, freeze a model or prompt, preserve traces, notify the incident lead, and identify affected users. Diagnosis comes after harm has stopped.
