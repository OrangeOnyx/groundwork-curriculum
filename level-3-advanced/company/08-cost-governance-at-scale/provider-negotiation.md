...
Negotiate usable capacity, price tiers, rate limits, support response, data terms, region availability, uptime credits, migration notice, and export rights. Validate contractual promises through load and failover tests.
