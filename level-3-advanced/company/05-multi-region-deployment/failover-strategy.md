...
Predefine whether failover stays in region, degrades functionality, queues work, or requires consent. Rehearse provider and region failures; an untested cross-region path is an assumption, not resilience.
