...
Rollback must be a practiced product capability. Specify the kill switch, the configuration or model version to restore, who may pull it, how users are informed, and how queued actions are safely handled.
