...
A bake-off is a decision process, not a demo. Compare models on representative, versioned cases with fixed budgets, safety tests, latency and cost measurements, and a predeclared decision rule.
