# Defining SLOs for AI

Define distinct objectives for service availability, time to first useful response, grounded answer quality, correct escalation, and safe action completion. Combine automated measurement with human review for quality dimensions.
