...
Protect a small, accountable research allocation for prototypes, benchmark replication, safety probes, and platform experiments. Every exploration should end with a decision, reusable artifact, or explicit reason not to proceed.
