# Executive Copilot — Knowledge Base Manifest
...
- [ ] Org chart with key context
- [ ] Investor thesis and cap table (as permitted)
- [ ] Competitive landscape brief (kept current)
- [ ] PR / comms style guide
