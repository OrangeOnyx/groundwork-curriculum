...
Short-term memory is session state needed to finish the current task. Long-term memory is retrieved, consented information that may shape future work. Give them different storage, retention, and review rules.
