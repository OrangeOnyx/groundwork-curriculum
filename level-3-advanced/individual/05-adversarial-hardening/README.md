...
Assume any text retrieved from a listing, email, PDF, vendor portal, or user can be hostile. Models process instructions and data through the same channel; your architecture must restore the boundary.
