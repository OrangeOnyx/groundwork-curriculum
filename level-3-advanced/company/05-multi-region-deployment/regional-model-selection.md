...
Select approved models per region using capability, latency, data terms, language coverage, safety evidence, and capacity. Model choice is a policy decision that should be encoded in the router.
