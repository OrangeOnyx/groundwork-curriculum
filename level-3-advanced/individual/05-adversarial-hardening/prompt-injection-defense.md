...
Separate untrusted content from system instructions, label it clearly, restrict tool authority, and validate tool arguments outside the model. Detection helps; permission design is the real control.
