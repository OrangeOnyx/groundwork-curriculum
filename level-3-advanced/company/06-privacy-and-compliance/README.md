...
Compliance starts with data minimization and purpose limitation. If a feature does not need a tenant’s phone number, lease attachment, or maintenance history, it should never receive it.
