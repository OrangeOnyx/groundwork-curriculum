...
Prepare a bounded evidence package: system inventory, data flows, risk assessments, policies, access records, evals, release approvals, incident records, vendor terms, and control tests. Make artifacts searchable before an auditor asks.
