...
Set SLAs for completeness, correctness, freshness, uniqueness, lineage, and authorization. A 99.9% pipeline success rate is irrelevant if the missing 0.1% contains emergency maintenance records.
