# Memory Hygiene in Production

Expire low-confidence memories, let users inspect and correct durable preferences, remove duplicates, and revalidate before high-impact action. Memory writes should be narrow, explicit, observable, and reversible.
