...
Map AI controls to security, availability, confidentiality, processing integrity, and privacy. Evidence should show the control operated: access reviews, change approvals, logging, vendor review, incidents, and recovery tests.
