...
Reserve capacity only after demand is measured and burst behavior is understood. Combine committed baseline capacity with on-demand overflow, then monitor utilization so discounts do not become expensive idle hardware.
