...
Measure the customer-visible service at the edge, record exclusions explicitly, retain supporting evidence, and align the calculation window to the contract. Provider uptime is not your customer SLA.
