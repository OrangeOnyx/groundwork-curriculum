...
An error budget is permission to move fast while reliability is healthy. When burn exceeds the policy, freeze risky launches, prioritize correctness work, and require executive exception for additional exposure.
