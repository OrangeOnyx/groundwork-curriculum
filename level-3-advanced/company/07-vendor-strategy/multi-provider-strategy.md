...
Use a capability router, normalized telemetry, comparable evals, portable prompts where practical, and provider-specific adapters at the edge. Maintain explicit rules for when fallback preserves quality and when it must degrade.
