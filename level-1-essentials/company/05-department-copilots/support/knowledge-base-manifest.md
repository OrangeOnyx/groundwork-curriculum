# Support Copilot — Knowledge Base Manifest

What to upload to the Custom GPT / Claude Project / Perplexity Space knowledge base.

## Required knowledge files

- [ ] Full internal knowledge base (with permissions preserved)
- [ ] Response tone guide
- [ ] Escalation matrix and on-call schedule
- [ ] Refund policy
- [ ] Product feature/behavior reference
- [ ] Known issues log
- [ ] Customer sentiment glossary
