...
Detect changed language, document layouts, property mix, channel mix, seasonality, and missing fields. Compare live distributions with a baseline by workflow, not one global number.
