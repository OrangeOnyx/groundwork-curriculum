...
Output drift includes answer length, refusal rate, tool-selection rate, citation coverage, escalation rate, and sentiment. A stable average score can conceal a new pattern of overly confident lease advice.
