# Marketing Copilot — Knowledge Base Manifest

What to upload to the Custom GPT / Claude Project / Perplexity Space knowledge base.

## Required knowledge files

- [ ] Brand style guide and voice doc
- [ ] Product one-pagers and messaging
- [ ] Approved customer quotes and case studies
- [ ] Content calendar
- [ ] SEO keyword research (up to date)
- [ ] Competitive positioning docs
- [ ] Analytics dashboards (or connector)
