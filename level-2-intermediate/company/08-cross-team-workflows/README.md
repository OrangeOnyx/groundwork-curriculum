...
Cross-team workflows only work if each person on each team has their own Personal Intelligence Layer in order — otherwise every handoff involves re-explaining context. If your team members struggle with "AI doesn't know my preferences" or "I keep re-explaining myself," they need the individual foundation from Groundwork Layer 3, not more org tooling. See [GROUNDWORK-AND-FLUENCY.md](../../../GROUNDWORK-AND-FLUENCY.md).
