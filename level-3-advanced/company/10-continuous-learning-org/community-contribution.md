...
Contribute fixes, eval cases, documentation, and safety findings where public sharing is appropriate. Open work can recruit talent and improve dependencies, but never publish customer data, exploit details, or unreviewed claims.
