...
Concept drift means the relationship between inputs and the right answer changed: policy updates, rent regulations, vendor terms, or a new maintenance classification. Refresh labels and policies, not just embeddings.
