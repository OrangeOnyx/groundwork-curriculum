...
Validate output structure, citations, policy claims, tone, prohibited data, and high-impact assertions. Use deterministic checks for deterministic policies, then escalate ambiguous cases instead of inventing certainty.
