...
Use a small cross-functional board for high-impact systems: product, engineering, privacy, security, operations, and legal when needed. It should approve risk acceptance, not rewrite every prompt.
