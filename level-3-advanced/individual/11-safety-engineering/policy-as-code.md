...
Express policy in testable rules: who may access which property, which action needs approval, when PII may appear, and when an answer must refuse. Version, review, test, and deploy policy like application code.
