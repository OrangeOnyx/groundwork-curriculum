...
Memory is a data product with permissions, expiry, and correction paths. An agent that remembers the wrong tenant preference or stale vendor instruction is less trustworthy than one that asks again.
