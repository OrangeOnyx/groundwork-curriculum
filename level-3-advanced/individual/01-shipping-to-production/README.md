...
Production is a promise about behavior under ordinary traffic, bad traffic, provider failures, and operator fatigue. Release the smallest useful slice, then earn broader access with evidence.
