...
Alert only when a shift is both statistically credible and operationally material. Pair distribution alarms with outcome metrics and a runbook; otherwise teams learn to ignore them.
