...
Tools need least privilege, typed parameters, allowlisted destinations, confirmation for irreversible actions, idempotency keys, rate limits, and audit logs. The model proposes; an enforcement layer authorizes.
