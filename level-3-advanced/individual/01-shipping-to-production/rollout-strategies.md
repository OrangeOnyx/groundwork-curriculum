# Rollout Strategies: Canary, Shadow, Flags, and Dark Launches

Canaries expose a small eligible cohort; shadow traffic compares answers without showing them; feature flags control eligibility; dark launches exercise tools and telemetry without customer impact. Use all four for different risks.
